	...
	<div id="container">
		...
		<div id="content">
			<div id="gallery">
				...
				<ul>
					<c:forEach begin="1" end="15" step="1" var="status"> 
						<li>
							<a	href="${pageContext.request.contextPath }/assets/gallery-examples/im${status}.jpg"
								data-lightbox="h"
								class="image"
								style="background-image:url('${pageContext.request.contextPath }/assets/gallery-examples/im${status}.jpg')">&nbsp;</a>
								<sec:authorize access="hasRole('ADMIN')" >
